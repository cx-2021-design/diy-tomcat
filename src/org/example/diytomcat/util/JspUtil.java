 ...
 * 作者：cjy
 * 类名：JspUtil
 * 全路径类名：org.example.diytomcat.util.JspUtil
 * 父类或接口：
 * 描述：jsp util
 */
public class JspUtil {
    ...
    public static void main(String[] args) {
        try {
            Context context = new Context("/javaweb", "d:/diytomcat/javaweb/web", null,true);
            File file = new File("d:/diytomcat/javaweb/web/index.jsp");
            compileJsp(context,file);//Jsp 转移和编译为java
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
     ...
     *         @param file 文件
     * 异常类型：@throws JasperException 碧玉例外
     * 返回类型：
     * 描述：jsp编译为Java
     */
